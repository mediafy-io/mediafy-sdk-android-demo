...
public class MediafyVideoInterstitialActivity extends BaseAdActivity {
    ...
    private void createAd() {
        // 1. Create MediafyInterstitialAdUnit
        ...
        adUnit.setAdUnitFormats(EnumSet.of(MediafyAdUnitFormat.VIDEO));
